...
Public Class TriniDATHTTPBrowser
    ...
    Public Sub New(Optional ByVal _logfunc As TriniDATHTTPTypes.TriniDATTypeLogger = Nothing)
    ...
    Public Function execGet(ByVal url As String, Optional ByVal srcForm As Object = Nothing) As Boolean
        ...
        End Try
    End Function
    Public Shared Function createFromHTML(ByVal htmldoc As String, ByVal from_url As String, Optional ByVal new_event_model As TriniDATBrowserEvents = Nothing, Optional ByVal _logfunc As TriniDATTypeLogger = Nothing) As TriniDATHTTPBrowser

        Dim retval As TriniDATHTTPBrowser
        retval = New TriniDATHTTPBrowser(_logfunc)
...
VERIFY_NEXT_LINK:
    ...
    Public ReadOnly Property getNodeBrowser(ByVal ni As TriniDATHTTPTypes.TriniDATNode, Optional ByVal new_event_model As TriniDATBrowserEvents = Nothing, Optional ByVal new_browser_tag As Object = Nothing) As TriniDATHTTPBrowser
        ...
        Get
            ...
            b = New TriniDATHTTPBrowser(Me.getLogger())
            Try
