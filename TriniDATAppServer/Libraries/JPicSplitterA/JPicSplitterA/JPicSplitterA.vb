...
Imports System.Collections.Specialized
    ...
    Public Sub OnGet(ByVal HTTP_URI_Path As String, ByVal HTTP_URI_Parameters As StringDictionary, ByVal HTTP_URI_Headers As StringDictionary)
        ...
        If HTTP_URI_Parameters("top") = "1" Then

            Dim my_picture_path As String
            Dim simon_speak As JSONObject

            simon_speak = New JSONObject
            simon_speak.ObjectType = "JTextToSpeech"
            simon_speak.Directive = "SPEAK"
            simon_speak.Attachment = "showing my fair daughter"
            Me.getMailProvider().send(simon_speak, Nothing, "JTextToSpeech")

            'resolve picture path.
            my_picture_path = Me.my_configuration_info.static_path & "JPicSplitter\top.jpg"
        ...
        Else
            ...
            Me.getIOHandler().addOutput("<img src=" & Chr(34) & Me.my_configuration_info.mapping_point_url & "?top=1" & Chr(34) & ">")
        End If
