...
Public Class ModProxy
    ...
    Private Structure INTERNET_PER_CONN_OPTION
        ...
        Public Function GetBytes() As Byte()
            ...
            Select Case dwOption
                ...
                Case (Options.INTERNET_PER_CONN_AUTOCONFIG_URL)

                    BitConverter.GetBytes(pszValue.ToInt32()).CopyTo(b, 4)

                Case (Options.INTERNET_PER_CONN_FLAGS_UI)
    ...
    End Function
    Public Function SetProxyIE8(ByVal proxy_full_addr As String) As Boolean
        ...
        opts(0).dwOption = Options.INTERNET_PER_CONN_FLAGS_UI
    ...
    End Function
    Public Function SetWPADProxy(ByVal wpad_fullurl As String) As Boolean
        ...
        opts(0).dwValue = Options.PROXY_TYPE_DIRECT Or Options.PROXY_TYPE_AUTO_PROXY_URL
        ...
        opts(1).pszValue = Marshal.StringToHGlobalAnsi(wpad_fullurl)
    ...
    End Function
    Public Function SetWPADProxyIE8(ByVal wpad_fullurl As String) As Boolean
    ...
    Public Function DisableProxyIE8() As Boolean
