...
Imports System.Collections.Specialized
    ...
    Public Sub OnGet(ByVal HTTP_URI_Path As String, ByVal HTTP_URI_Parameters As StringDictionary, ByVal HTTP_URI_Headers As StringDictionary)
        ...
        If HTTP_URI_Parameters("bottom") = "1" Then

            Dim my_picture_path As String

            'resolve picture path.
            my_picture_path = Me.my_configuration_info.static_path & "JPicSplitter\bottom.jpg"
        ...
        Else
            ...
            Me.getIOHandler().addOutput("<img src=" & Chr(34) & Me.my_configuration_info.mapping_point_url & "?bottom=1" & Chr(34) & ">")
        End If
